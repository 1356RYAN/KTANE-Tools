...
for x in range(3):
    slot = int(input("Input slot position:"))
    slot_num_orig = int(input("Input slot number:"))
    ...
    def slot_position1(slot_num2):
        ...
        right_num = int(input("Input the original digit of the 2nd slot:"))
    ...
    def slot_position2(slot_num3):
        ...
        if unlit_BOB == 1:
            ...
            one_slot = int(input("Input the original digit of the 1st :"))
    ...
    def slot_position3(slot_num4,slot_num4_orig):
        ...
        same = int(input("Input 1 if any other original digit is same as slot 3 original one, 0 if not:"))
        if serial_port == 1:
